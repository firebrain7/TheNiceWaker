package com.example.exp.sleep.Splash;
...
import com.example.exp.sleep.Activity.LoginActivity;
...
public class GuideActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        View guideOne=inflater.inflate(R.layout.activity_guide1, null);//每个xml中就放置一个imageView
        View guideTwo=inflater.inflate(R.layout.activity_guide2,null);
